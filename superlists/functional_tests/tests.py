...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        #Planning to store my repo at superlists-staging.bradjackson.site
        if staging_server:
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        self.wait_for_row_in_list_table('1: Buy batteries')
        ...
        self.wait_for_row_in_list_table('1: Buy batteries')
        self.wait_for_row_in_list_table('2: put batteries into remote')
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## We use a new browser session to make sure that no info of
        ## Edith's is coming trhough from cookies etc
        self.browser.quit()
        self.browser = webdriver.Firefox()
